...
const Rewards: React.FC = () => {
  return (
    <div className="h-[70vh] flex flex-col items-center justify-center p-6 animate-slide-up text-center">
      ...
      <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Rewards Store</h2>
      ...
      <p className="text-eco-200 max-w-md mx-auto mb-8 leading-relaxed">
        We are building a marketplace where your eco-points can be exchanged for sustainable products, tree planting donations, and digital collectibles.
      </p>
